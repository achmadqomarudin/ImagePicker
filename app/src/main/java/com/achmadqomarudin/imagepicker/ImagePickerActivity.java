...
import com.achmadqomarudin.imagepicker.imageloader.PicassoImageLoader;
import com.achmadqomarudin.imagepicker.wxdemo.WxDemoActivity;
...
public class ImagePickerActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener, CompoundButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckBox cb_show_camera = findViewById(R.id.cb_show_camera);
        ...
        CheckBox cb_isSaveRectangle = findViewById(R.id.cb_isSaveRectangle);
        cb_isSaveRectangle.setOnCheckedChangeListener(this);
        cb_isSaveRectangle.setChecked(true);

        Button btn_open_gallery = findViewById(R.id.btn_open_gallery);
        btn_open_gallery.setOnClickListener(this);
        Button btn_wxDemo = findViewById(R.id.btn_wxDemo);
